...
| **价值奖励** (v2.2) | 0-30 | 对投资/全球局势/金融市场高价值文章加权（权威源/价值关键词/市场资产/多源并发） | 五维输出 + 分类 |
| **总分**            | **100** | 五维累加 + 价值奖励, 封顶 100            | —                              |

> **价值奖励 v2.2 (2026-08-08)**：新增第 6 个加权维度，目的把对【投资/全球局势/金融市场】有价值的文章升入 B/A 级（获得 LLM 深度增强），解决评分保守致高价值文章被淹没（原 A=0/B=4.6%）。奖励权重可经配置中心「评分」Tab 覆盖（`value.reward_*`）。
>
> **奖励组成**（封顶 30）：权威源≥16 +4 · 关键词分类 finance+5/geopolitics+6/market+5/china+3 · 市场资产+3 · 多源并发+3 · **高价值实体分级**（`value_tiers.json`）：
>
> | 级别 | 定义 | 奖励 | 覆盖 |
> |:--:|------|:--:|------|
> | **T1** | GDP 大国一把手 | +8 | 习近平/Xi·Trump·普京·莫迪·朔尔茨·斯塔默·马克龙·石破茂·卢拉 |
> | **T2** | GDP 大国二把手 | +6 | 万斯/耶伦/卢比奥/鲍威尔·李强·米舒斯京/拉夫罗夫/绍伊古 |
> | **T3** | 核心政府机构 | +5 | 白宫/财政部/五角大楼·国务院/商务部/外交部/解放军/发改委·克里姆林宫 |
> | **T4** | 核心机构/央行/国际组织 | +4 | 美联储/ECB/人行·IMF/世行/联合国/NATO/WTO/OPEC/欧盟/G7/G20 |
> | **T5** | 世界金融巨头 | +6 | JPMorgan/高盛/摩根大通/BlackRock/花旗/UBS/汇丰/德银/巴克莱 |
> | **T6** | AI 科技巨头 | +6 | NVIDIA/英伟达/OpenAI/Anthropic/DeepSeek/谷歌/微软/苹果/TSMC/AMD/ASML/三星/高通 |
> | **T7** | 国产替代核心公司 | +7 | 华为/海思/中芯国际/长江存储/长鑫存储/中微公司/北方华创/寒武纪/海光信息/龙芯/澜起/华大九天/上海微电子/中科曙光 |
> | **T8** | 韬定律先进封装全产业链 | +7 | 设备: ASMPT/库力索法/EVG/SUSS/BESI/DISCO/东京电子/应用材料 · 封测: 长电科技/通富微电/日月光/Amkor/华天 · EDA: Cadence/Synopsys/芯原/概伦 · 材料: 深南/沪电/兴森/生益/联瑞/Ibiden/欣兴/AT&S |
> | **T9** | 机器人/机械臂核心公司 | +6 | 优必选/宇树/埃斯顿/新松/汇川/拓斯达/绿的谐波 · ABB/发那科/库卡/安川/Figure/波士顿动力/特斯拉 |
> | **T10** | 光通信/光芯片核心公司 | +6 | 中际旭创/新易盛/天孚通信/光迅科技/烽火/中兴 · Coherent/Lumentum/Ciena/Fabrinet/Marvell · 光库/长光华芯/源杰/仕佳光子/住友电工/Veeco/AIXTRON |
>
> **机器人关键词奖励**：命中 机械臂/人形机器人/具身智能/embodied AI/协作机器人/cobot/伺服电机/谐波减速器 等 → +4。
> **实体边界修复 (v2.2)**：`_entity_in_text` 用 ASCII 词边界替代 `\b`，修复拉丁名+中文邻接漏检（Coherent推出/Lumentum业绩/ABB工业/Intel发布 现在都能识别）。
> 实体命中多级**累加**（Trump+美联储 = T1+T4 = 12），每级计一次，实体奖励封顶 20。
> 实测 5000 篇：A 0→68(1.4%)、B 232→332(6.6%)。A 级入选伊朗战争/特朗普/Anthropic $10B 交易/长鑫存储 IPO/长电封测扩产；B 级入选华为芯片/DUV 光刻机/ASMPT/日月光/深南电路。
...
| 指标                      | 旧 (133词+substring) | 新 (511词+v2) | 说明                |
| ----------------------- | :----------------: | :---------: | ----------------- |
| 平均 impact 分             |       14.30        |    7.28     | 旧 substring 系统性虚高 |
| impact=0 文章             |        1283        |    2619     | +1336 篇纠正为 0（原误标） |
| 新增命中（新>旧）               |         —          |    451 篇    | 511 词覆盖面提升        |
| **误标修复**（word_boundary） |         —          | **1591 篇**  | 核心收益              |
| 真关键词精化                  |         —          |     4 篇     | 台海→台海危机 / GPU→芯片  |
| `Federal Reserve` 全名缺口  |         —          |     3 篇     | 均为低价值审批公告，可接受     |

**结论**：旧 scorer 纯 substring 在技术/学术文本大量误标（`war`→hardware、`UN`→Underestimated、`GPU`→GPUS 股票代码、`Fed`→Feedback）。v2 word_boundary 修复 **1591 处误标** + 511 词新增 **451 处真实命中**。平均分下降是**正确性修复**，非能力损失；tier 分布将更准确（减少虚高 A/B 级）。
...
**数据规模**: entity_weights.json — **199 公司 + 77 人物 + 34 国 + 101 机构 = 559 实体**（含中英别名）。完整实体→权重表如下（命中多个取最高，封顶 20）。
